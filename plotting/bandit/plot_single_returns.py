...
def plot(x_dict, y_dict, linestyle_dict, color_dict):
    ...
    plt.legend()
    plt.title(f'Average return for each task', fontsize='large')
    plt.ylim(-2.1,1.1)
...
if __name__ == "__main__":
    ...
    key = f"Goal2D1"
    results_dir = f"../../results/ppo_goal2d_singletask_1/dro/results/Goal2D1/ppo"
    # color_palette = iter(seaborn.color_palette('colorblind', n_colors=10))
    ...
    # Goal2D2 AVERAGE #################################################################################################
    key = f"Goal2D2"
    results_dir = f"../../results/ppo_goal2d_singletask_1/dro/results/Goal2D2/ppo"
    # color_palette = iter(seaborn.color_palette('colorblind', n_colors=10))
    ...
    # Goal2D3 AVERAGE #################################################################################################
    key = f"Goal2D3"
    results_dir = f"../../results/ppo_goal2d_singletask_1/dro/results/Goal2D3/ppo"
    # color_palette = iter(seaborn.color_palette('colorblind', n_colors=10))
    ...
    # Goal2D4 AVERAGE #################################################################################################
    key = f"Goal2D4"
    results_dir = f"../../results/ppo_goal2d_singletask_1/dro/results/Goal2D4/ppo"
    # color_palette = iter(seaborn.color_palette('colorblind', n_colors=10))
