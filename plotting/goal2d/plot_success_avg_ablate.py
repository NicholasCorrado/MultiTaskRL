...
if __name__ == "__main__":
    ...
    results_dir = f"../../results/ppo_goal2d_6/success_ref/results/Goal2D1_Goal2D2_Goal2D3_Goal2D4/ppo"
    # color_palette = iter(seaborn.color_palette('colorblind', n_colors=10))
    ...
    # STANDARD AVERAGE #################################################################################################
    key = f"Standard"
    results_dir = f"../../results/ppo_goal2d_6/no_dro/results/Goal2D1_Goal2D2_Goal2D3_Goal2D4/ppo"
    # color_palette = iter(seaborn.color_palette('colorblind', n_colors=10))
    ...
    save_dir = f'figures'
    save_name = f'success_rate_avg_ablate.png'
