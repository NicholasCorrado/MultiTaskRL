...
if __name__ == "__main__":
    ...
    for i in range(n):
        ...
        if y is not None:
            ...
            linestyle_dict[key] = '-'
            color_dict[key] = next(color_palette)
    plot(x[:T], y_dict, linestyle_dict, color_dict, title='Task Return: DRO', ylabel='Return')
    ...
    for i in range(n):
        ...
        if y is not None:
            ...
            linestyle_dict[key] = '-'
            color_dict[key] = next(color_palette)
    plot(x[:T], y_dict, linestyle_dict, color_dict, title='Task Return: Standard', ylabel='Return')
    plt.axhline(y=1, color='k', linestyle='--', label='Optimal return')
    plt.legend()
