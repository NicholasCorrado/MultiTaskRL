...
if __name__ == "__main__":
    ...
    results_dir = f"../../results/gridworld/results/GridWorldEnv1_GridWorldEnv2_GridWorldEnv3_GridWorldEnv4/ppo/success_ref"
    ...
    # STANDARD AVERAGE #################################################################################################
    key = f"Standard"
    results_dir = f"../../results/gridworld/results/GridWorldEnv1_GridWorldEnv2_GridWorldEnv3_GridWorldEnv4/ppo/no_dro"
    # color_palette = iter(seaborn.color_palette('colorblind', n_colors=10))
