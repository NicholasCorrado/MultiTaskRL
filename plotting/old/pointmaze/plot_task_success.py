...
if __name__ == "__main__":
    ...
    for i in range(n):
        ...
        if y is not None:
            ...
            linestyle_dict[key] = '-'
            color_dict[key] = next(color_palette)
    plot(x[:T], y_dict, linestyle_dict, color_dict, title='Task Return: DRO', ylabel='Return', y_bottom=0.0)
    ...
    for i in range(n):
        ...
        if y is not None:
            ...
            linestyle_dict[key] = '-'
            color_dict[key] = next(color_palette)
    plot(x[:T], y_dict, linestyle_dict, color_dict, title='Task Return: Standard', ylabel='Return', y_bottom=0.0)
    plt.axhline(y=1, color='k', linestyle='--', label='Optimal return')
    plt.legend()
    ...
    plot(x[:T], y_dict, linestyle_dict, color_dict, title='Sampling Weights: DRO', ylabel='Sampling Weight', y_bottom=-0.1, y_top=1.1)
    ...
    plot(x[:T], y_dict, linestyle_dict, color_dict, title='Sampling Weights: Standard', ylabel='Sampling Weight', y_bottom=-0.1, y_top=1.1)
    x_dict, y_dict, linestyle_dict, color_dict = {}, {}, {}, {}
