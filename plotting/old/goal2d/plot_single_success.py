...
if __name__ == "__main__":
    ...
    env_id = 'Goal2D1-v0_Goal2D2-v0_Goal2D3-v0_Goal2D4-v0'
    ...
    key = f"Goal2D1"
    results_dir = f"../../results/ppo_goal2d_singletask_1/results/Goal2D1/ppo"
    # color_palette = iter(seaborn.color_palette('colorblind', n_colors=10))
    ...
    # Goal2D2 AVERAGE #################################################################################################
    key = f"Goal2D2"
    results_dir = f"../../results/ppo_goal2d_singletask_1/results/Goal2D2/ppo"
    # color_palette = iter(seaborn.color_palette('colorblind', n_colors=10))
    ...
    # Goal2D3 AVERAGE #################################################################################################
    key = f"Goal2D3"
    results_dir = f"../../results/ppo_goal2d_singletask_1/results/Goal2D3/ppo"
    # color_palette = iter(seaborn.color_palette('colorblind', n_colors=10))
    ...
    # Goal2D4 AVERAGE #################################################################################################
    key = f"Goal2D4"
    results_dir = f"../../results/ppo_goal2d_singletask_1/results/Goal2D4/ppo"
    # color_palette = iter(seaborn.color_palette('colorblind', n_colors=10))
