...
def plot_metric_on_ax(ax, path_dict, linestyle_dict, color_dict, metric_name, title):
    ...
    for key, results_dir in path_dict.items():
        ...
        T = 40  # reduce this value if you want to truncate the data
        if y is not None:
            x_dict[key] = x[:T]
            y_dict[key] = y[:, :T]
...
if __name__ == "__main__":
    ...
    path_dict = {
        'DRO': f"../../chtc/results1/mt4_1/results/ppo/dro/lr_{lr}/ns_{ns}",
        'DRO, reweight': f"../../chtc/results1/mt4_1/results/ppo/dro_reweight/lr_{lr}/ns_{ns}",
        'Hard First': f"../../chtc/results1/mt4_1/results/ppo/hard_first/lr_{lr}/ns_{ns}",
        'Easy First': f"../../chtc/results1/mt4_1/results/ppo/easy_first/lr_{lr}/ns_{ns}",
        'Learning Progress': f"../../chtc/results1/mt4_1/results/ppo/learning_progress/lr_{lr}/ns_{ns}",
        'Uniform': f"../../chtc/results1/mt4_1/results/ppo/uniform/lr_{lr}/ns_{ns}",
    }
    path_dict = {
        'DRO': f"../../chtc/results1/mt4_3/results/ppo/dro/lr_{lr}/ns_{ns}",
        'DRO, reweight': f"../../chtc/results1/mt4_3/results/ppo/dro_reweight/lr_{lr}/ns_{ns}",
        'Hard First': f"../../chtc/results1/mt4_3/results/ppo/hard_first/lr_{lr}/ns_{ns}",
        'Easy First': f"../../chtc/results1/mt4_3/results/ppo/easy_first/lr_{lr}/ns_{ns}",
        'Learning Progress': f"../../chtc/results1/mt4_3/results/ppo/learning_progress/lr_{lr}/ns_{ns}",
        'Uniform': f"../../chtc/results1/mt4_3/results/ppo/uniform/lr_{lr}/ns_{ns}",
    }
    ...
    fig.legend(handles, labels, loc='upper center', fontsize='x-large', ncols=7)

    os.makedirs("figures", exist_ok=True)
    plt.savefig("figures/success_rate_tasks.png", dpi=200)
    plt.show()