...
if __name__ == "__main__":
    ...
    results_dir = f"../../results/pointmaze_2/success_ref/results/PointMaze1_PointMaze2_PointMaze3/ddpg"
    ...
    # STANDARD AVERAGE #################################################################################################
    key = f"Standard"
    results_dir = f"../../results/pointmaze_2/no_dro/results/PointMaze1_PointMaze2_PointMaze3/ddpg"
    # color_palette = iter(seaborn.color_palette('colorblind', n_colors=10))
