...
if __name__ == "__main__":
    ...
    plot(x_dict, y_dict, linestyle_dict, color_dict, title='Task Success Rate: DRO', ylabel='Success Rate')
    ...
    for i in range(5):
        ...
        if y is not None:
            ...
            linestyle_dict[key] = '-'
            color_dict[key] = next(color_palette)
    plot(x_dict, y_dict, linestyle_dict, color_dict, title='Task Success Rate: Standard', ylabel='Success Rate')
    plt.axhline(y=1, color='k', linestyle='--', label='Optimal\nsuccess rate')
    plt.legend()
    ...
    for i in range(5):
        ...
        if y is not None:
            ...
            linestyle_dict[key] = '-'
            color_dict[key] = next(color_palette)
    plot(x_dict, y_dict, linestyle_dict, color_dict, title='Task Return: DRO', ylabel='Return')
    ...
    for i in range(5):
        ...
        if y is not None:
            ...
            linestyle_dict[key] = '-'
            color_dict[key] = next(color_palette)
    plot(x_dict, y_dict, linestyle_dict, color_dict, title='Task Return: Standard', ylabel='Return')
    plt.axhline(y=1, color='k', linestyle='--', label='Optimal return')
    plt.legend()
    ...
    results_dir = f"../chtc/results/5bandits/results/{env_id}/ppo/dro/lr_{lr}/ns_{ns}"
    color_palette = iter(seaborn.color_palette('colorblind', n_colors=10))
    for i in range(5):
        key = f"Task {i+1}"
    ...
    plot(x_dict, y_dict, linestyle_dict, color_dict, title='Sampling Weights: DRO', ylabel='Sampling Weight')
    ...
    plot(x_dict, y_dict, linestyle_dict, color_dict, title='Sampling Weights: Standard', ylabel='Sampling Weight')
    x_dict, y_dict, linestyle_dict, color_dict = {}, {}, {}, {}
